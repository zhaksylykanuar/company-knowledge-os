...
export const M = {
  ...
  githubProductConnect: {
    ...
    liveSyncPendingDescription:
      "FounderOS продолжает загрузку в фоне и сам покажет результат. Страницу можно оставить открытой или остановить задачу.",
    liveSyncCancel: "Остановить загрузку",
    liveSyncCancelling: "Останавливаем…",
